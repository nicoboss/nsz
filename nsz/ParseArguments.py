...
class ParseArguments:
	...
	def parse():
		...
		parser.add_argument('-Q', '--quick-verify', action="store_true", default=False, help='Skips the expensive and mostly useless PFS0 hash verification and only verifies NCA hashes')
