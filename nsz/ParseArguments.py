...
class ParseArguments:
	...
	def parse():
		...
		parser.add_argument('-K', '--no-intro', action="store_true", default=False, help='Keep all delta fragment files during compression so the PFS0 container can be recreated bit-identical during decompression')
